# Nano Banana prompt: Inference Engineering

Recommended model: `gemini-3-pro-image-preview`

Create a minimalist technical book thumbnail for "Inference Engineering".
Theme: model serving, token streams, prefill/decode split, GPU memory lanes, latency curves, and AI factory topology.
...
Include title text clearly: "Inference Engineering".
