# Nano Banana prompt: AI Security

Recommended model: `gemini-3-pro-image-preview`

Create a minimalist technical book thumbnail for "AI Security".
Theme: policy gates, tool boundaries, model sandboxes, audit trails, identity boundaries, red-team traces, and data access control.
