# Nano Banana prompt: AI Coding

Recommended model: `gemini-3-pro-image-preview`

Create a minimalist technical book thumbnail for "AI Coding".
Theme: code review loops, agentic development workflows, test harnesses, diffs, tool calls, repository maps, and software delivery feedback cycles.
...
Include title text clearly: "AI Coding".
